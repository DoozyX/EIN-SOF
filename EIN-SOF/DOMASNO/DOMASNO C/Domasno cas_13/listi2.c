   ...
   while ( choice != 5 ) {
      ...
      switch ( choice ) {
         ...
         case 2:
            ...
            break;
         case 3:
            sortRastecki(&startPtr);  /*povikuvanje na sortRastecki*/
            printList( startPtr );
            break;
         case 4:
            sortOpagacki(&startPtr);  /*povikuvanje na sortOpagacki*/
            printList( startPtr );
            break;
         default:
...
void instructions( void )
{
   printf( "Vnesi izbor:\n"
      ...
      "   3 za sortiranje vo rastecki redosled.\n"
      "   4 za sortiranje vo opagacki redosled.\n"
      "   5 za kraj.\n" );
